...
public class GameLobbyData implements Protocol{
	...
	public static final short GAME_READY = 6100; //게임준비.
	public static final short CANCEL_READY = 6199; //준비취소.
	public static final short GAME_START = 6200; // 게임스타트.
 	public static final short EXIT_ROOM = 9100; //방나가기.
